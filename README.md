...
### 🚀 Featured Professional & Personal Work
...
<p><b>[Proprietary]</b> Serverless database-agnostic Slack agent using LLMs and RAG (pgvector). Built with a multi-lambda Terraform infrastructure and autonomous syntax validation.</p>
</div>
</td>
...
<p><b>[Proprietary]</b> End-to-end system processing 190,000+ tests. Features a Go API, React Native mobile client for on-site parsing, and custom CNN models for handwritten digit recognition.</p>
</div>
</td>
</tr>
...
<p><b>[In Progress]</b> Computer vision pipeline utilizing U-Net segmentation and custom PDF parsers to automate municipal regulatory compliance and paperwork.</p>
</div>
</td>
...
<p>Self-hosted recipe web application integrated with a Kotlin mobile app for real-time household inventory tracking and automated shopping lists.</p>
</div>
</td>
</tr>
</table>
...
<a href="https://github.com/benjahuenchunir/arqui-backend" target="_blank">
...
<p>Microservice-based betting platform deployed via CI/CD to AWS (EC2 + S3/CloudFront). Features an asynchronous task queue (Celery/Redis) for transaction processing, an MQTT event-driven broker, and full APM observability with New Relic.</p>
</div>
</td>
...
<p>Real-time instant messaging web application built with React. Co-created with <a href="https://github.com/PipeXtz">@PipeXtz</a> and <a href="https://github.com/fvidalf">@fvidalf</a>.</p>
</div>  
</td>
</tr>
...
<p>Course scheduling algorithm that generates all possible timetable combinations based on custom user constraints (allowed overlaps, campus, professor, format, etc.) using Python and PyQt5.</p>
</div>                                                          
</td>
...
<img src="https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white">
<img src="https://img.shields.io/badge/Qt-41CD52?style=for-the-badge&logo=qt&logoColor=white">
<p>Turn-based battle game developed to demonstrate Object-Oriented Programming (OOP) principles. Built with Python and a graphical interface using PyQt5. Co-created with <a href="https://github.com/TheMightyTsar">@TheMightyTsar</a>, <a href="https://github.com/fvidalf">@fvidalf</a>, <a href="https://github.com/damiangubbins">@damiangubbins</a>, and <a href="https://github.com/artufin">@artufin</a>.</p>
</div>                                                          
</td>
</tr>
</table>
